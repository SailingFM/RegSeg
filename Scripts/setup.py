...
"""pyacwereg : Instrumentation software to evaluate the regseg tool.
...
def configuration(parent_package='', top_path=None):
    ...
    config.get_version('pyacwereg/__init__.py')  # sets config.version
    config.add_subpackage('pyacwereg', 'pyacwereg')
    return config
...
pkg_chk('nipype', INFO_VARS['NIPYPE_MIN_VERSION'])
pkg_chk('dipy', INFO_VARS['DIPY_MIN_VERSION'])
